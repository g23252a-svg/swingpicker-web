...
CHANGELOG: List[Dict[str, Any]] = [
    {
        ...
        "date": "2026-03-02",
        "type": "major",
        "title": "⚡ 시스템 리뉴얼 & 멤버십 오픈",
        "items": [
            "🔄 **시스템 전면 리셋:** 기존 회원 데이터 초기화 — 모든 분들께서 새로 가입해주셔야 합니다.",
            "📧 **이메일 인증 도입:** 가입 시 이메일 인증코드 확인 필수 (본인 확인 강화)",
            "💎 **멤버십 시스템 오픈:** Free(무료) / Prime(39,000원/월) 구독 플랜",
            "🏦 **무통장 입금 결제:** 카카오뱅크 계좌이체로 간편 결제 (카드결제 준비 중)",
            "🔒 **프리미엄 기능 분리:** AI 포트폴리오, 전략 백테스트 등은 Prime 전용",
            "📊 **무료 회원도 사용 가능:** 시장 현황, 종목 분석(TOP 3) 등 기본 기능 제공",
        ],
        "schema_min": 5
    },
    {
