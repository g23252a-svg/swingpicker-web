...
CHANGELOG: List[Dict[str, Any]] = [
    {
        ...
        "date": "2026-07-13",
        "type": "minor",
        "title": "v26.1 — Profit Recovery: 체결·비용·OOS 검증 추천과 영구 0건 해소",
        "items": [
            "📈 **검증된 후보 승격:** 기존 TOP_PICK∧BUY_NOW_ELIGIBLE의 97거래일 동시 발화 0건 의존을 제거. 유동성·MFI·저항여력·VWAP·손익비·데이터 무결성 규칙을 통과한 종목을 하루 최대 1개 공식 추천.",
            "🧪 **실행 가능한 시간순 검증:** 2026-04-10~06-29, 지정가 3일 체결·10일 보유·왕복비용 0.22%·동일봉 손절 우선. 42신호/35체결, Train 평균 +2.16%, 최근 Test +0.50%. 95% 부트스트랩 하단은 음수라 LIMITED_DEPLOYMENT로 제한.",
            "🛡️ **손익 비대칭·소액 비중:** 공식 가격을 진입가 대비 -6% 손절/+10% 목표로 통일. NORMAL 최대 3%, CAUTION 최대 2%, 하루 신규진입 최대 1종목.",
            "💱 **환율 영구 차단 수정:** 1,490원 이상이라는 절대 수준만으로 CRITICAL이 되던 로직을 수정. 고환율은 CAUTION, 고환율 상태에서 5거래일 +2% 급등이 겹칠 때만 CRITICAL.",
            "👁️ **빈 화면 해소:** 약한 시장에서는 억지 매수 대신 실제 검증 셋업 상위 3개를 ‘매수 아님’ 관찰 후보로 표시. 공식 매수·관찰·현금 결정을 첫 화면에서 분리.",
        ],
        "schema_min": 5,
    },
    {
