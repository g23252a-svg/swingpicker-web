...
CHANGELOG: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "items": [
            ...
            "📉 **맥락 정직 고지:** 누적 데이터 105일 전 구간이 하락장이다(유니버스 5일수익 일평균 -1.28%, 승률 32%, 겹침보정 자본 -18%). **UP 레짐은 단 하루도 없다.** 워크포워드 알파 재구성 결과 IC +0.156(t=10.0, 양수일 89%)·롱숏 스프레드 +1.39%/5일(t=4.02)로 순위 신호는 강하지만, 롱온리 절대수익은 이 구간에서 어떤 조합도 플러스가 아니었다 — 상대 엣지와 낙폭 축소가 검증 가능한 성과의 한계다.",
        ],
        "schema_min": 5,
    },
    {
