...
st.warning(
    "⚠️ 투자 관련 유의사항\n\n"
    "LDY Pro Trader는 주식 투자 의사결정을 돕기 위한 데이터 및 알고리즘 기반 분석 도구입니다.\n"
    "제공되는 모든 정보는 일반적인 참고용 자료일 뿐이며,\n"
    "특정 종목의 매수·매도, 수익 실현 또는 손실 회피를 보장하지 않습니다.\n\n"
    "실제 매수·매도 등 투자에 대한 최종 의사결정과 그에 따른 결과(손실 포함)에 대한 책임은 "
    "전적으로 이용자 본인에게 있으며,\n"
