...
- Features: AI Narrative, Tab Layout, Text Portfolio, Mobile Friendly
- Fix: NameError, IndexError Resolved
"""
        ...
        try:
            ...
            for line in lines:
                ...
                try:
                    ...
                    signal = "🟢 수익" if rate > 0 else ("🔴 손실" if rate < -3 else "🟡 보합")
