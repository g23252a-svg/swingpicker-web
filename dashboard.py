...
- Features: All unlocked (No Password), Tab Layout, Sparkline, AI Narrative
"""
...
def build_global_score(lat):
    ...
    # [Fix] AI Comment가 있으면 WHY 대신 사용, 없으면 WHY 사용
...
with tab1:
    ...
    with c_gauge:
        ...
        st.caption("시장 공포/탐욕 지수 (RSI + 이격도 기반)")
