# -*- coding: utf-8 -*-
"""
LDY Pro Trader v5.6 (Final Fix Ultimate)
- Fix: Global Constants Scope Error (Defined at Top Level)
- Features: Smart Filters, Excel Portfolio, Visual Risk Bar
"""
...
# 3. [핵심 수정] 상수 및 설정 (전역 변수로 최상단 배치)
# 이 변수들이 함수 밖에 있어야 모든 함수가 에러 없이 읽을 수 있습니다.
...
def build_global_score(lat):
    ...
    pen += P_OVERHEAT_10D * np.clip((nz_num(x["ret_10d_%"]) - 20)/20, 0, 1)
