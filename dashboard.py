# -*- coding: utf-8 -*-
"""
LDY Pro Trader v5.8 (Final Integrated)
- Fix: Global Variable Scope Error (PASS_EBS)
- Features: Subscription Model (Free/Pro/Prime), AI Narrative, Visual Charts
"""
