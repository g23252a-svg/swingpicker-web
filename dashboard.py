# -*- coding: utf-8 -*-
"""
LDY Pro Trader v5.7 (Final Robust)
- Fix: NameError (Variables defined INSIDE functions)
- Features: All Unlocked, Tab Layout, AI Narrative, Mobile View
"""
...
def build_global_score(lat):
    # [Fix] 상수를 함수 안으로 가져옴 (NameError 방지)
    PASS_EBS = 4
